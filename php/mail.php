<?php 
	...
	$to = 'kruckovm245@gmail.com';
	require_once('PHPMailerAutoload.php');
	$mail = new PHPMailer;
	$mail->ClearAddresses();
	$mail->addAddress($to);
	$mail->Subject = 'Заявка «Запчасти для грузовых автомобилей»';
	$mail->IsHTML(true);
	$mail->CharSet = "UTF-8";
	$mail->msgHTML('
		<div style="padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px; font-weight: bold; font-size: 17px;">'.PostData("form_subject", "Форма", "auto").'</div>
		'.PostData("name", "Имя").'
